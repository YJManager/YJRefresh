#
#  Be sure to run `pod spec lint YJRefresh.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "http://EXAMPLE/YJRefresh"
  ...
  s.source       = { :git => "http://EXAMPLE/YJRefresh.git", :tag => "#{s.version}" }
